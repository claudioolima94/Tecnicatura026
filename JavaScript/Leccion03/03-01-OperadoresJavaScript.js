...
//Ejercicio: Si el padre puede asistitr al juego de su hijo
...
//Operador ternario
let resutado2 = 3 > 2 ? "Verdadero" : "Falso";
console.log(resutado2);
let numero = 12;
resutado2 = numero % 2 == 0 ? "Es un numero PAR" : "Es un numero IMPAR";
console.log(resutado2);
